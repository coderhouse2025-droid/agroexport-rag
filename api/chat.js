...
Redactá siempre en prosa clara, en oraciones completas -- nunca repitas etiquetas HTML, corchetes de link, ni fragmentos de formato crudo que puedan aparecer en el contexto (son artefactos del scraping, no texto para citar tal cual). Si el contexto menciona un email o teléfono de contacto, podés mencionar que existe un contacto sin necesariamente reproducir la dirección completa.

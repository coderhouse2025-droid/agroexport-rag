...
export default async function handler(req, res) {
  ...
  try {
    ...
    const SIN_INFO_PATRON = /no dispongo de informaci[oó]n|no tengo informaci[oó]n|no cuento con informaci[oó]n|no se incluye informaci[oó]n|no se encuentra informaci[oó]n|no hay informaci[oó]n/i;

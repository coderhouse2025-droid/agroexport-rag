...
const TITULO_REGISTRO_RETENCIONES =
  "Alícuotas de retenciones (derechos de exportación) vigentes tras los Decretos 877/2025 y 423/2026 transcripción de los Anexos oficiales";
...
async function buscarContexto(pregunta) {
  ...
  if (RE_RETENCIONES.test(pregunta)) {
    dirigidas.push({ nombre: "retenciones", texto: TITULO_REGISTRO_RETENCIONES, topK: 3 });
  }

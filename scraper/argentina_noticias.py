...
URLS_A_SCRAPEAR = [
    ...
    # Derechos de exportación (retenciones) -- comunicado oficial que SÍ explica los porcentajes
    # en prosa (soja 24%->21%->15%, trigo/cebada 9,5%->7,5%, etc). Se agrega porque el Decreto
    # 423/2026 en sí (ver arca_normativa.py) fija las alícuotas remitiendo a 3 Anexos que son
    # archivos GDE (IF-2026-...-APN-SSMAEII#MEC) sin URL pública descargable -- probablemente
    # PDFs escaneados/tabulares, no texto plano -- así que el decreto solo queda en el RAG con el
    # texto legal genérico (VISTO/CONSIDERANDO/vigencia), sin los números concretos. Este
    # comunicado es la fuente que sí permite al RAG contestar "¿cuánto pago de retenciones por
    # soja?" con un número real (detectado 10/09/2026 al validar en producción).
    "https://www.argentina.gob.ar/noticias/el-gobierno-nacional-oficializo-una-nueva-reduccion-de-los-derechos-de-exportacion-al-campo",
]

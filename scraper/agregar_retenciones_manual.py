...
REGISTRO_MANUAL = {
    ...
    "cuerpo": (
        "Trigo y cebada: la alícuota del derecho de exportación bajó de 7,5% a 5,5% (dos puntos "
        "porcentuales), vigente desde el 4 de junio de 2026 (día siguiente a la publicación del "
        "decreto), de aplicación inmediata.\n\n"
        ...
        "RAG).\n\n"
        "Nota metodológica: este registro es un resumen elaborado a mano el 10/09/2026, cruzando "
        "cobertura periodística de La Nación, Infobae e Infocampo sobre el Decreto 423/2026 "
        "(publicado el 03/06/2026), porque el texto legal del decreto remite las alícuotas "
        "concretas a Anexos que no están disponibles como texto plano. Verificar contra el "
        "Boletín Oficial (https://www.boletinoficial.gob.ar/detalleAviso/primera/342702/20260603) "
        "antes de tomar una decisión operativa o de pago."
    ),
    "anexos_pdf": [],
}

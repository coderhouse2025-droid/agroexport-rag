...
// Las 3 preguntas que se muestran en Inicio y en "Consultas frecuentes". Elegidas a
// propósito (26/09/2026) entre las que ya probamos a fondo esta sesión, porque cada
// una muestra algo distinto que la app resuelve bien:
// - Soja a China: caso SENASA solo, con el aviso de plazo vencido.
// - Maíz a China + retención: caso con SENASA y ARCA a la vez (sellos agrupados), y
//   el caso puntual donde la app aclara que esa fuente NO trae Declaración Jurada de
//   zarandeo para maíz, en vez de inventarla.
// - Decreto 423/2026: devuelve las alícuotas completas por producto con su cronograma,
//   no solo "consultá el anexo" (que es lo que decía antes de las últimas correcciones).
const PREGUNTAS_EJEMPLO = [
  "¿Qué necesito para exportar soja a China?",
  "¿Qué necesito para exportar maíz a China y cuánto pago de retención?",
  "¿Qué dice el decreto 423/2026?",
];

...
function Sello({ fuente, esFavorito, onAlternarFavorito }) {
  ...
  const estrella = (
    <button
      ...
      onClick={(e) => {
        e.preventDefault(); // no seguir el link de la norma si la estrella está dentro de <a>
        e.stopPropagation();
...
function Mensaje({ mensaje, pregunta, seEstaGenerando, favoritosIds, onAlternarFavorito }) {

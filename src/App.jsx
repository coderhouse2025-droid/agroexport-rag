    ...
    <div className="app">
      <header className="app-header">
        <div className="app-header-marca">
          <img src="/logo.jpg" alt="Ceres AI" className="app-header-logo-img" />
          <div className="app-header-textos">
            <span className="app-header-logo">Ceres AI</span>
            <span className="app-header-tagline">Agrotech &amp; Export Assistant</span>
          </div>
        </div>
      </header>
        ...
        {mensajes.length === 0 ? (
          <div className="estado-vacio">
            <p className="estado-vacio-texto">
              Preguntame sobre requisitos fitosanitarios y aduaneros para exportar soja, maíz,
              trigo o girasol desde Argentina.
            </p>
            <div className="chips">
